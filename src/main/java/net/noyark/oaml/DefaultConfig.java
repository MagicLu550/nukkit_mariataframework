...
public class DefaultConfig implements OamlConfig{
	...
	public DefaultConfig(String fileName,boolean getClassPath) throws FileNotFoundException {
		this(fileName,DocumentFactory.getDocument(), getClassPath);
	}
	public DefaultConfig(String fileName,Document doc,boolean getClassPath) throws FileNotFoundException {
		if(getClassPath) {
